...
public class Configuration {
    ...
    public static final String
            DATABASE_URL="jdbc:mysql://localhost/villaggio?user=root&password=Andreadelfatto00&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone="+SERVER_TIMEZONE;
    ...
    public static final String GLOBAL_LOGGER_FILE="/Users/andreadelfatto/Documenti/logs/villagevista_log.%g.%u.txt";
